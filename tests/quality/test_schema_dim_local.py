...
class TestDimLocalQueimadaSchema:
    ...
    def test_columns_exist(self, dim_local_queimada):
        ...
        # id_local_clima might be optional
        if "id_local_clima" in actual_columns:
            expected_columns.add("id_local_clima")
    ...
    def test_id_local_dtype(self, dim_local_queimada):
        ...
        assert dim_local_queimada["id_local"].dtype in [pl.UInt32, pl.Int64, pl.Int32]
